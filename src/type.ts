...
export type CreateModel = <D extends StoreData, A extends StoreActions = {}, B extends Model<StoreData> | null = null>(
    initiator: CreateModelInitiator<D, A, B>
) => Model<D & PickModelData<B>, A & PickModelActions<B>, PickModelActions<B>>
